...
const MovieDetail = () => {
  ...
  const { data, isLoading, error } = useFetchMoviesOrShows(imdbID);
        ...
        <>
          <div className="section-left">
            ...
            <MovieRating>
              ...
              <span>
                Year <i className="fa fa-calendar"></i> : {data?.Year || "N/A"}
              </span>
            </MovieRating>
          ...
          <SectionRight>
            <img
              src={data?.Poster || "https://example.com/default-poster.jpg"}
