...
// // jest.mock('./components/PageNotFound/PageNotFound', () => () => <div>Mocked_404_Page</div>);
...
//     //   renderWithRouter('/movie/12345');
//     //   expect(screen.getByText('Mocked Movie Detail Page')).toBeInTheDocument();
//     // });
